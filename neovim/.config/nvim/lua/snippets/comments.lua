...
_G.luasnip.vars = {
  username = 'rensftw',
  github = 'https://github.com/rensftw',
  real_name = 'Irena Angelova',
}

--- Options for marks to be used in a TODO comment
local marks = {
  signature = function()
    return fmt('<{}>', i(1, _G.luasnip.vars.real_name))
  end,
  date_signature = function()
    return fmt('<{}{}>', { i(1, _G.luasnip.vars.real_name), i(2, ', ' .. os.date '%d-%m-%y') })
  end,
  date = function()
