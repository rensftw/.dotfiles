...
vim.opt.shortmess:append('c') -- don't pass messages to |ins-completion-menu| (append, don't clobber defaults)
...
vim.o.undodir = vim.fs.joinpath(vim.fn.stdpath('state'), 'undodir')
